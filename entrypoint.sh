...
PGPASSWORD="VSuJTfwhrTxYW9snZxM7sL84nL696GTb82c32445" pg_dump --host evendate.ru --port 5432 --username "postgres" --role "postgres" --format tar --encoding UTF8 --exclude-table-data=log_requests --verbose --file /var/www/deployer/db_dump.backup "evendate"
