...
PGPASSWORD="VSuJTfwhrTxYW9snZxM7sL84nL696GTb82c32445" pg_dump --host evendate.ru --port 5432 --username "postgres" --role "postgres" --format tar --encoding UTF8 --exclude-table-data=log_requests --exclude-table-data=recommendations_events --exclude-table-data=recommendations_organizations --verbose --file /var/www/deployer/db_dump.backup "evendate"
...
curl -X POST --data-urlencode 'payload={"channel": "#web_bots", "username": "webhookbot", "text":  "Docker run done", "icon_emoji": ":ghost:"}' https://hooks.slack.com/services/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
